...
all: uClibc++_only $(NEW_LIB_ONLY) lib_only user_only modules romfs soft_version linux image
else
all: config_error
endif
...
DIRS    =  $(ROOTDIR)/vendors include uClibc++ user $(NEW_LIB) lib
...
soft_version:
	@echo "==============soft version=========" 
	@cp -rf "vendors/Ralink/MT7620/RT2860_default_vlan" "vendors/Ralink/MT7620/RT2860_default_vlan_temp"
	@echo "HE_ROUTE_VER=$(shell date +%y%m)-9-001-R$(word 2,$(shell svn info ./ | grep Revision:))" >> ./vendors/Ralink/MT7620/RT2860_default_vlan_temp
	@cp -rf "vendors/Ralink/MT7620/RT2860_default_vlan_temp" "./romfs/etc_ro/Wireless/RT2860AP/RT2860_default_vlan"
	@rm -rf ./romfs/etc_ro/Wireless/RT2860AP/RT2860_default_vlan_temp
...
.PHONY: subdirs
subdirs: lib $(NEW_LIB) uClibc++ linux modules
