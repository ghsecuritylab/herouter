...
"$Id: //WIFI_SOC/MP/SDK_4_2_0_0/RT288x_SDK/source/user/ppp-2.4.2/pppd/plugins/rp-pppoe/plugin.c#1 $";
...
PPPOEConnectDevice(void)
{
	...
	if (conn->discoveryState != STATE_SESSION) {
      ...
      //set status for herouter
      system("echo timeout > /var/pppoe_status");
