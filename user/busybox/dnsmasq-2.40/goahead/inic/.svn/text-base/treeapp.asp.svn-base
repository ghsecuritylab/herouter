...
var rax_vowb = '<% getVoWBuilt("ra0"); %>';
var raix_vowb = '<% getVoWBuilt("rai0"); %>';
...
else
{
	...
	if (rax_vowb == "1")
		a.add(412, 400, "VoW",            			"javascript:go('wireless/vow.asp');");
}
...
if (rai == "1")
{
	...
	if (raix_vowb == "1")
		a.add(509, 500, "VoW",            			"javascript:go('inic/vow.asp');");
}
...
if (opmode != '0') {
	if (pktfilterb == '0') {
		a.add(700,   0, _("treeapp nat_set"),              "javascript:a.oo(700);");
	} else {
		...
		a.add(702, 700, _("treeapp system firewall"),       "javascript:go('firewall/system_firewall.asp');");
		a.add(703, 700, _("treeapp content filtering"),     "javascript:go('firewall/content_filtering.asp');");
	}
	a.add(704, 700, _("treeapp port forwarding"),       "javascript:go('firewall/port_forward.asp');");
	a.add(705, 700, _("treeapp port trigger"),          "javascript:go('firewall/port_trigger.asp');");
	a.add(706, 700, _("treeapp dmz"),                   "javascript:go('firewall/DMZ.asp');");
}
