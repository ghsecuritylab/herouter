...
function PageInit()
{
	var txbf = "<% getRaiXTxBfBuilt(); %>";
	var vowb = '<% getVoWBuilt("rai0"); %>';
	...
	if (txbf == "1") {
		...
		document.getElementById("div_info_vow").style.visibility = "hidden";
		document.getElementById("div_info_vow").style.display = "none";
	} else if (vowb == "1") {
		document.getElementById("div_info_normal").style.visibility = "hidden";
		document.getElementById("div_info_normal").style.display = "none";
...
<table id="div_info_vow" width="540" border="1" cellpadding="2" cellspacing="1">
  <tr>
    <td bgcolor=#E8F8FF id="stalistMacAddr">MAC Address</td>
    <td bgcolor=#E8F8FF>Aid</td>
    <td bgcolor=#E8F8FF>PSM</td>
