...
var ht_ldpc = '<% getCfg2Zero(1, "HT_LDPC"); %>';
var ht_f_40mhz = '<% getCfg2Zero(1, "HT_40MHZ_INTOLERANT"); %>';
var vht_stbc = '<% getCfg2Zero(1, "VHT_STBC"); %>';
var vht_sgi = '<% getCfg2Zero(1, "VHT_SGI"); %>';
var vht_bw_signal = '<% getCfg2Zero(1, "VHT_BW_SIGNAL"); %>';
var vht_ldpc = '<% getCfg2Zero(1, "VHT_LDPC"); %>';
...
function insertExtChannelOption()
{
	...
	if ((1*wmode == 9) || (1*wmode == 8) || (1*wmode >= 12))
	{
		var x = document.getElementById("n_extcha");
		var length = document.wireless_basic.n_extcha.length;
		...
		if ((1*wmode == 8) || (1*wmode == 14) || (1*wmode == 15))
		{
		...
		else if (1*wmode == 9)
		{
			...
			option_length = document.wireless_basic.sz11gChannel.length;
...
function ChannelOnChange()
{
	if (document.wireless_basic.n_bandwidth[1].checked == true)
	{
		...
		if ((1*w_mode == 8) || (1*w_mode == 14)|| (1*w_mode == 15))
		{
			if (document.wireless_basic.n_bandwidth[1].checked == true)
			{
			...
			if (document.wireless_basic.sz11aChannel.selectedIndex == 0)
			{
		...
		else if (1*w_mode == 9)
		{
			...
			if (document.wireless_basic.sz11gChannel.selectedIndex == 0)
			{
				document.getElementById("extension_channel").style.visibility = "hidden";
				document.getElementById("extension_channel").style.display = "none";
				document.wireless_basic.n_extcha.disabled = true;
...
function changeVHTBW()
{
	...
	document.getElementById("div_vht_bw").style.visibility = "hidden";
	document.getElementById("div_vht_bw").style.display = "none";
	document.wireless_basic.vht_bandwidth[0].disabled = true;
	document.wireless_basic.vht_bandwidth[1].disabled = true;
	if (1*w_mode >= 12)
	{
		document.getElementById("div_vht_bw").style.visibility = "visible";
		document.getElementById("div_vht_bw").style.display = style_display_on();
		if (document.wireless_basic.n_bandwidth[1].checked == true)
		{
...
function initValue()
{
	...
	document.getElementById("div_11vht").style.visibility = "hidden";
	document.getElementById("div_11vht").style.display = "none";
	...
	if (PhyMode >= 8)
	{
		...
		if (PhyMode >= 12)
		{
			document.getElementById("div_11vht").style.visibility = "visible";
			if (window.ActiveXObject) // IE
				document.getElementById("div_11vht").style.display = "block";
			else if (window.XMLHttpRequest)  // Mozilla, Safari,...
				document.getElementById("div_11vht").style.display = "table";
	...
	else if ((PhyMode == 2) || (PhyMode == 8) || (PhyMode == 14) || (PhyMode == 15))
	{
	...
	{
			document.wireless_basic.sz11gChannel.selectedIndex = 0;
			}
		...
		if ((CntyCd == 'US' || CntyCd == 'TW') && (ChIdx < 1 || ChIdx > 11))
			{
			document.wireless_basic.sz11bChannel.selectedIndex = 0;
			}
		else if ((CntyCd == 'FR' || CntyCd == 'IE' || CntyCd == 'HK') && (ChIdx < 1 || ChIdx > 13))
			{
			document.wireless_basic.sz11bChannel.selectedIndex = 0;
		...
		if (CntyCd == 'HK' && (ChIdx < 36 || (ChIdx > 64 && ChIdx < 149) || ChIdx > 165))
			{
			document.wireless_basic.sz11aChannel.selectedIndex = 0;
			}
	...
	{
		ht_mcs = 1*ht_mcs;
		document.wireless_basic.abg_rate.length = 0;
		...
		if (fxtxmode == "CCK" || fxtxmode == "cck") {
			if (ht_mcs == 0)
				document.wireless_basic.abg_rate.selectedIndex = 1;
			else if (ht_mcs == 1)
				document.wireless_basic.abg_rate.selectedIndex = 2;
			else if (ht_mcs == 2)
				document.wireless_basic.abg_rate.selectedIndex = 3;
			else if (ht_mcs == 3)
				document.wireless_basic.abg_rate.selectedIndex = 6;
			else
				document.wireless_basic.abg_rate.selectedIndex = 0;
		}
		else {
			if (ht_mcs == 0)
				document.wireless_basic.abg_rate.selectedIndex = 4;
			else if (ht_mcs == 1)
				document.wireless_basic.abg_rate.selectedIndex = 5;
			else if (ht_mcs == 2)
				document.wireless_basic.abg_rate.selectedIndex = 7;
			else if (ht_mcs == 3)
				document.wireless_basic.abg_rate.selectedIndex = 8;
			else if (ht_mcs == 4)
				document.wireless_basic.abg_rate.selectedIndex = 9;
			else if (ht_mcs == 5)
				document.wireless_basic.abg_rate.selectedIndex = 10;
			else if (ht_mcs == 6)
				document.wireless_basic.abg_rate.selectedIndex = 11;
			else if (ht_mcs == 7)
				document.wireless_basic.abg_rate.selectedIndex = 12;
			else
				document.wireless_basic.abg_rate.selectedIndex = 0;
		}
	}
	...
	*/
	...
	var option_length = document.wireless_basic.n_extcha.length;

	if (1*ht_extcha == 0)
	{
		if (option_length > 1)
			document.wireless_basic.n_extcha.selectedIndex = 0;
	}
	else if (1*ht_extcha == 1)
	{
		if (option_length > 1)
			document.wireless_basic.n_extcha.selectedIndex = 1;
	}
	else
	{
		document.wireless_basic.n_extcha.selectedIndex = 0;
...
function wirelessModeChange()
{
	...
	*/
	...
	{
		//document.wireless_basic.wirelessmode.selectedIndex = 1;
		document.getElementById("div_11b_channel").style.visibility = "visible";
		document.getElementById("div_11b_channel").style.display = style_display_on();
		document.wireless_basic.sz11bChannel.disabled = false;
	}
	...
	{
		//document.wireless_basic.wirelessmode.selectedIndex = 2;
		document.getElementById("div_11g_channel").style.visibility = "visible";
		document.getElementById("div_11g_channel").style.display = style_display_on();
		document.wireless_basic.sz11gChannel.disabled = false;
	}
	...
	{
		//document.wireless_basic.wirelessmode.selectedIndex = 3;
		document.getElementById("div_11a_channel").style.visibility = "visible";
		document.getElementById("div_11a_channel").style.display = style_display_on();
		document.wireless_basic.sz11aChannel.disabled = false;
	}
	else if ((wmode == 8) || (wmode == 14) || (wmode == 15))
	{
		//document.wireless_basic.wirelessmode.selectedIndex = 4;
		document.getElementById("div_11a_channel").style.visibility = "visible";
		document.getElementById("div_11a_channel").style.display = style_display_on();
		document.wireless_basic.sz11aChannel.disabled = false;
		document.getElementById("div_11n").style.visibility = "visible";
	...
	{
		//document.wireless_basic.wirelessmode.selectedIndex = 5;
		document.getElementById("div_11g_channel").style.visibility = "visible";
		document.getElementById("div_11g_channel").style.display = style_display_on();
		document.wireless_basic.sz11gChannel.disabled = false;
		document.getElementById("div_11n").style.visibility = "visible";
...
<table width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  ...
  <tr> 
    ...
    <td><input type=text name=ssid size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID1"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID1">Multiple SSID</font>1</td>
    <td><input type=text name=mssid_1 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID2"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID2">Multiple SSID</font>2</td>
    <td><input type=text name=mssid_2 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID3"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID3">Multiple SSID</font>3</td>
    <td><input type=text name=mssid_3 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID4"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID4">Multiple SSID</font>4</td>
    <td><input type=text name=mssid_4 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID5"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID5">Multiple SSID</font>5</td>
    <td><input type=text name=mssid_5 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID6"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID6">Multiple SSID</font>6</td>
    <td><input type=text name=mssid_6 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID7"); %>"></td>
  </tr>
  <tr> 
    <td class="head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font id="basicMSSID7">Multiple SSID</font>7</td>
    <td><input type=text name=mssid_7 size=20 maxlength=32 value="<% getCfg2ToHTML(1, "SSID8"); %>"></td>
  </tr>
  <tr> 
...
<table id="div_11n" name="div_11n" width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD" style="display:none">
  ...
  <tr>
    ...
    <td>
      <select id="n_mcs" name="n_mcs" size="1">
...
<table id="div_11vht" name="div_11vht" width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD" style="display:none">
  ...
  <tr id="div_vht_bw">
    ...
    <td>
      <input type=radio name=vht_bandwidth value="0" checked>20/40&nbsp;
      <input type=radio name=vht_bandwidth value="1">80
    </td>
  </tr>
  <tr>
