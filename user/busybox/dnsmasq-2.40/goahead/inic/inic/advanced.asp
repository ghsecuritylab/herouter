...
var m2uEnabled = '<% getCfg2Zero(1, "M2UEnabled"); %>';
...
var txbfb = '<% getRaiXTxBfBuilt(); %>';
var etxbf = '<% getCfg2Zero(1, "ETxBfEnCond"); %>';
var itxbf = '<% getCfg2Zero(1, "ITxBfEn"); %>';
var dfsb = '<% getRaixDFSBuilt(); %>';
var carrierib = '<% getRaixCarrierBuilt(); %>';
var m2uBuilt = '<% getRaiXM2UBuilt(); %>';
...
function initValue()
{
	...
	if (extchlistb != "1") {
		...
		document.getElementById("div_support_channel").style.visibility = "hidden";
		document.getElementById("div_apsd_capable").style.display = "none";
	}
