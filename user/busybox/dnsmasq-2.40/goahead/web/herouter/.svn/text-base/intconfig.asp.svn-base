...
<form method=post name="quickSettingWan" id="quickSettingWan" action="/goform/setWan" >
<div class="int">
...
<tr id="MtuSetting">
							<td><span>MTU设置</span></td>	
								<td><input class="inp1" id="MTU"  type="text"  name="MTU" value="<% getCfgGeneral(1, "Pppoe_Mtu"); %>"  /><li class="STYLE1">默认是1492，请勿修改！</li></td>
