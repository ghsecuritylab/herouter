...
<body>
<form method=post name="quickSettingWan" id="quickSettingWan" action="/goform/QuickSetUp" >
<div class="int">
...
<h1 align="center"><span class="Txttype">(第一步)互联网设置<em>--></em></span>(第二步)无线设置—>(第三步)完成</h1>
    ...
    <div class="cfg">
			<!--div id="fail" class="c1" style="width:500px"><b class="err">经检测，您的上网方式可能为<% getCfgGeneral(1, "wanConnectionMode"); %>，请手动设置账号和密码</b></div>
			<div id="pass" class="c1" style="width:360px"><b>经检测，您的上网方式为<% getCfgGeneral(1, "wanConnectionMode"); %></b></div-->
        <div class="cfgright">
          <table width="70%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr id="ipAddr">
                ...
                <td><input class="inp1" type="text" name="staticIp" value="<% getWanIp(); %>"/></td>
              	<td width="30%" ></td>
              </tr>
              <tr id="netMask">
                <td><span>子网掩码</span></td>
                <td><input class="inp1" type="text" name="staticNetmask" value="<% getWanNetmask(); %>" /></td>
              </tr>
              <tr id="gateway">
                <td><span>网关</span></td>
                <td><input class="inp1" type="text" name="staticGateway" value="<% getWanGateway(); %>" /></td>
              </tr>
              <tr id="priDNS">
                <td><span>首选DNS</span></td>
                <td><input class="inp1" type="text" name="staticPriDns" value="<% getDns(1); %>" /></td>
              </tr>
              <tr id="secDNS">
                <td><span>备用DNS</span></td>
                <td><input class="inp1" type="text" name="staticSecDns" value="<% getDns(2); %>" /></td>
              </tr-->
          </table>    
					<table width="70%" border="0" cellspacing="0" cellpadding="0" > 
							<br>             
              <tr id="PPPOEUser">
              	<td><span>PPPoE账户</span></td>	
  							<td><input class="inp1" type="text"  name="pppoeUser" value="<% getCfgGeneral(1, "wan_pppoe_user"); %>" /></td>            	
              </tr>
							<tr id="PPPOEPassword">
								<td><span>PPPoE密码</span></td>	
								<td><input class="inp1" id="pppoePass" onclick="pppoeSetting_showpasswd()" type="password"  name="pppoePass" value="<% getCfgGeneral(1, "wan_pppoe_pass"); %>"  /></td>            	
							</tr>
          </table>
            <tr style="display: none; ">
							  <td><input name="connectionType" id="connectionType" value=""  style="display: none;"/></td>
							  <td><input name="hostname" id="hostname" value="<% getCfgZero(1, "wan_dhcp_hn"); %>"  style="display: none;"/></td>
							  <td><input name="macCloneEnbl" id="macCloneEnbl" value=<% getCfgZero(1, "macCloneEnabled"); %>  style="display: none;"/></td>
							  <td><input name="macCloneMac" id="macCloneMac" value="<% getCfgGeneral(1, "macCloneMac"); %>"  style="display: none;"/></td>
							  <td><input name="pppoeOPMode" id="pppoeOPMode" value="<% getCfgGeneral(1, "wan_pppoe_opmode"); %>"  style="display: none;"/></td>
							  <td><input name="pppoeRedialPeriod" id="pppoeRedialPeriod" value="<% getCfgGeneral(1, "wan_pppoe_optime"); %>"  style="display: none;"/></td>
						</tr>
            <div class="subpart">
                <ul>
