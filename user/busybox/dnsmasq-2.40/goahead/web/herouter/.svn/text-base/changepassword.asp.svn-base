      	...
      	<form method="post" name="Adm" id="Adm" action="/goform/setSysAdm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td id="defaultpwd"><font color="#CF9E9E"><h5>(初始密码:123456)</h5></font></td>
                <td><em id="pwderr" style="display:none;">密码错误，请重试</em></td>
              </tr>
              <tr>
                <td width="29%"><span>新密码</span></td>
                <td width="28%"><input class="inp1" type="password" name="newpass" value=""/></td>
                <td id="lenerr" style="display:none;"><em>密码长度4-15位</em></td>
                <td id="buferr" style="display:none;"><em>不能包含空格</em></td>
              </tr>
              <tr>
                <td><span>重复新密码</span></td>
                <td><input class="inp1" type="password" name="admpass" value=""/></td>
                <td><em id="differr" style="display:none;">请与新密码保持一致</em></td>
              </tr>
            </table>
            <div class="subpart">
                <ul>
