...
<div class="int">
    ...
    <div class="cfg">
        ...
        <form method="post" name="settime" action="/goform/setSysTime">
        <div class="cfgright">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr id="curtime">
                <td colspan="8">当前系统时间：<% getSysTime(); %> </td>
              </tr>
              <tr id="manNTPServer">
							  <td><span2>NTP服务器</span2></td>
							  <td colspan="6"><input class="inp1" size="32" maxlength="64" id="NTPServerIP" name="NTPServerIP" value="<% getCfgGeneral(1, "NTPServerIP"); %>" type="text">
							  </td>
							  <td>
							...
							<tr id="manNTPSync">
							  ...
							  <td colspan="6"><input class="inp1" size="4" id="NTPSync" name="NTPSync" value="<% getCfgGeneral(1, "NTPSync"); %>" type="text"> </td>
							</tr>
              <tr id="sysdate">
                <td><span>修改为</span></td>
              ...
              <tr id="systime">
				...
				<input class="selectinp" type="text" id="select1" name="hour" /></td>
                <td width="6%">时</td>
                <td width="14%">
				<div class="fix" style=" z-index:999;">
				...
				<input class="selectinp" type="text" id="select2" name="minute" /></td>
                <td width="6%">分</td>
                <td width="14%">
				<div class="fix" style=" z-index:999;">
				...
				<input class="selectinp" type="text" id="select3" name="second" /></td>
                <td width="19%" >秒</td>
              </tr>
            </table>
            <div class="subpart">
...
var mode = "<% getCfgGeneral(1, "timeSetMode"); %>";
...
function NTPFormCheck()
{
	...
	if(atoi(document.getElementById("NTPSync").value, 1) > 300){
		alert("同步时间值太大!(1~300)");
		return false;
	}		
	return true;
