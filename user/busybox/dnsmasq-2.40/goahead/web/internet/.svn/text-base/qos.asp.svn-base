...
var QoSModeType = "<% getCfgGeneral(1, "QoSModeType"); %>";
...
function hideSFQReserveBW()
{
	document.getElementById("ReserveBandwidth").style.visibility = "hidden";
	document.getElementById("ReserveBandwidth").style.display = "none";
	document.getElementById("ReserveBandwidthStr").style.visibility = "hidden";
	document.getElementById("ReserveBandwidthStr").style.display = "none";
}
...
function onInit()
{
	...
	if(QoS == "0"){
		...
		document.QoSSetup.ModeType.disabled = true;
		document.QoSSetup.Model.disabled = true;
		...
		document.QoSSetup.ModeType.disabled = false;
	...
	if (QoSModeType == 1){
		document.QoSSetup.ModeType.options.selectedIndex =0;
	}else if(QoSModeType == 2){
		document.QoSSetup.ModeType.options.selectedIndex =1;
	}
	if(document.QoSSetup.QoSSelect.options.selectedIndex!=0){
		if(document.QoSSetup.ModeType.options.selectedIndex ==0) /*Auto Config*/
		{
			//document.QoSSetup.Model.disabled = true;
			//document.QoSSetup.ReserveBandwidth.disabled = true;
			QoSModelHide();
...
function QoSModelHide()
{
	tr_hide("QoSModel_Str");
	//tr_hide("Model");
	
	
}
function QoSReserveHide()
{
	tr_hide("ReserveBandwidth_Str");
	//tr_hide("ReserveBandwidth");
	
}
function QoSModelShow()
{
	tr_show("QoSModel_Str");
	//tr_show("Model");
	
}
function QoSReserveShow()
{
	tr_show("ReserveBandwidth_Str");
	//tr_show("ReserveBandwidth");
}
...
<tr>
	<td class="head" id="QoSType">
		QoS Type:
	</td>
	<td>
		<select name="ModeType" id="ModeType" size="1" onchange="QoSSelectChange()">
		<option value="1">AUTO QoS</option>
		<option value="2">MANUAL QoS</option>
	 </select>
	</td>
</tr>
