...
function init()
{
	var root_rate = '<% getCfgGeneral(1, "BW_Root"); %>';
	var grate_str = '<% getCfgGeneral(1, "BW_Guarantee_Rate"); %>';
	var crate_str = '<% getCfgGeneral(1, "BW_Maximum_Rate"); %>';
	var priority_str = '<% getCfgGeneral(1, "BW_Priority"); %>';
...
<input type=hidden name=interface value="ra0">
  ...
  <tr>
    <td class="head" colspan="4">
      Root Rate:<input type=text name="root_rate" value="<% getCfgGeneral(1, "BW_Root"); %>" size=3 maxlength=4>Mb
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor=#edc240><% getCfgToHTML(1, "SSID1"); %>
  ...
  <tr>
    <td bgcolor=#afd8f8><% getCfgToHTML(1, "SSID2"); %>
  ...
  <tr>
    <td bgcolor=#cb4b4b><% getCfgToHTML(1, "SSID3"); %>
  ...
  <tr>
    <td bgcolor=#4da74d><% getCfgToHTML(1, "SSID4"); %>
