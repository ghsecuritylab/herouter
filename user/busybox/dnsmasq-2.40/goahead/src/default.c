 ...
 *
 * $Id: //WIFI_SOC/MP/SDK_4_2_0_0/RT288x_SDK/source/user/goahead/src/default.c#1 $
 */
...
/*********************************** Code *************************************/
/* Replace the specific buffer in the position where matched
 */
int StrReplace(char *sSrc, char *sMatchStr, char *sReplaceStr)
{
        int  StringLen;
        char caNewString[512];
