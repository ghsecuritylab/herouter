...
#define RTPRIV_IOCTL_GET_FILTER_MAC_TABLE_STRUCT		(SIOCIWFIRSTPRIV + 0x1E)	/* modified by zhuzhh@dare, 20114/05/21 */
#define RTPRIV_IOCTL_SET_FILTER_HIDE_SSID   		(SIOCIWFIRSTPRIV + 0x1D)	    /* modified by zhuzhh@dare, 20114/05/25 */
