...
#endif /* RTMP_RBUS_SUPPORT */
			break;
		case CMD_RTPRIV_IOCTL_GET_FILTER_MAC_TABLE_STRUCT: /* DARE, zhuzhh, 20140521, add  */
			RTMPIoctlGetFilterMacTableStaInfo(pAd, wrq);
			break;
		case CMD_RTPRIV_IOCTL_SET_FILTER_HIDE_SSID: /* DARE, zhuzhh, 20140825, add  */
			RTMPIoctlSetFilterHideSsid(pAd, wrq);
			break;
