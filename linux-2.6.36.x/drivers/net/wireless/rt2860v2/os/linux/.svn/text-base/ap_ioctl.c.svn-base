...
/* modified by Red@Ralink, 2009/09/30 */
		...
		case RTPRIV_IOCTL_GET_MAC_TABLE_STRUCT:
			...
			break;
		case RTPRIV_IOCTL_GET_FILTER_MAC_TABLE_STRUCT: /* DARE, zhuzhh, 20140521, add  */
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_FILTER_MAC_TABLE_STRUCT, 0, NULL, 0);
			break;
		case RTPRIV_IOCTL_SET_FILTER_HIDE_SSID: /* DARE, zhuzhh, 20140825 add  */
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_SET_FILTER_HIDE_SSID, 0, NULL, 0);
			break;
/* end of modification */
